...
import { cn } from "../../lib/utils"; // Assuming cn is a utility function you have in your React project
...
const TextArea = React.forwardRef(({ className, type, ...props }, ref) => {
  ...
  return (
    <motion.div
      ...
      className="p-[2px] rounded-lg transition duration-300 group/input"
    >
      <textarea id="w3review" name="w3review"         className={cn(
